...
const Expansion = () => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          "http://localhost:8000/expansion_plans",
  ...
  const columns = [
    { field: "company_name", headerName: "Franchisor", flex: 2 },
    {
      field: "planned_new_locations",
      headerName: "Planned Expansions",
      flex: 2,
    },
    {
      field: "growth_strategy",
      headerName: "Growth Strategy",
      flex: 1,
    },
  ];
  return (
